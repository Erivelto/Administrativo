	...
	public class CadastroRepLegalController : Controller
    {
		...
		public async Task<ActionResult> Edite(int rep)
		{
			...
			using (var client = new HttpClient())
			{
				...
				{
					clientCont.BaseAddress = new System.Uri("http://gerenciadorfccadastroservicos20180317071207.azurewebsites.net/api/Contato?" + "codigoRep=" + rep.ToString() + "&val=0");
		...
		{
			var url = "https://gerenciadorfcadministrativoweb20180319080544.azurewebsites.net/Account/Register?returnUrl=" + codigo.ToString() + "&tipo=" + tipo + "&data=" + data + "&email=" + email;
